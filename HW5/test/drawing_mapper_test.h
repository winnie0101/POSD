...
class DrawingMapperSuite : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(DrawingMapperSuite, Sanity)
{
}

TEST_F(DrawingMapperSuite, Find) {
    // DrawingMapper* mapper = new DrawingMapper();
    ...
    Drawing* drawing2 = mapper->find("d_0001");
    ASSERT_EQ(drawing, drawing2);
}
